                        ...
                        <div class="center-item">
                            <ul class="menu-list">
                                  ...
                                  <li class="menu-item has-children">
                                    ...
                                    <ul class="sub-menu">
                                        <li class="sub-menu-item">
                                            <a href="{{ route('admin.all_users')  }}" class="">
                                ...
                                <li class="menu-item has-children">
                                    ...
                                    <ul class="sub-menu">
                                        <li class="sub-menu-item">
                                            <a href="{{ route('admin.employee.add') }}" class="">
                                                <div class="text">Add Employees</div>
                                            </a>
                                        </li>
                                        <li class="sub-menu-item">
                                            <a href="{{ route('admin.all_employees') }}" class="">
                                                <div class="text">Employees</div>
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <li class="menu-item">
                                    <a href="{{ route('admin.leave_request') }}" >
                                        <div class="icon">    <i class="fas fa-file-alt"></i></div>
                                        <div class="text">Leave Requests</div>
                                    </a>
                ...
                <div class="section-content-right">
                    ...
                    <div class="main-content">
                        ...
                        <div class="bottom-page">
                            <div class="body-text">Copyright © 2024 Smart Leave Mangement Systen</div>
                        </div>
                    </div>
