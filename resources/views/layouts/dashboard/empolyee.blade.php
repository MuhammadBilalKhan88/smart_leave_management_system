...
<head>
    <title>Samart Leave Mangement</title>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('dashboard/css/apexcharts.css') }}">
                            ...
                            <ul class="menu-list">
                                ...
                                <li class="menu-item has-children">
                                    ...
                                    <a href="javascript::void(0)">
                                        <div class="icon"> <i class="fa-solid fa-user-alt"></i></div>
                                        <div class="text">Leaves</div>
                                    </a>

                                    <ul class="sub-menu">
                                        <li class="sub-menu-item">
                                            <a href="{{ route('employee.leaves.request.form') }}" class="">
                                                <div class="text">Leave request Form</div>
                                            </a>
                                        </li>
                                        <li class="sub-menu-item">
                                            <a href="{{ route('employee.leaves.request.histroy') }}" class="">
                                                <div class="text">Leaves History</div>
                                            </a>
                                        </li>
                                                ...
                                                <ul>
                                                    <li class="product-item gap14 mb-10">
                                                        <div class="image no-bg">
                                                            <img src="{{ asset('dashboard/images/products/17.png') }}"
                                                                alt="">
                                                        </div>
                                                    ...
                                                    <li class="product-item gap14 mb-10">
                                                        <div class="image no-bg">
                                                            <img src="{{ asset('dashboard/images/products/18.png') }}"
                                                                alt="">
                                                        </div>
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                                    ...
                                                    <li class="product-item gap14">
                                                        <div class="image no-bg">
                                                            <img src="{{ asset('dashboard/images/products/19.png') }}"
                                                                alt="">
                                                        </div>
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                        ...
                                        <ul class="">
                                            ...
                                            <li>
                                                <ul>
                                                    <li class="product-item gap14 mb-10">
                                                        <div class="image no-bg">
                                                            <img src="{{ asset('dashboard/images/products/20.png') }}"
                                                                alt="">
                                                        </div>
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                                    ...
                                                    <li class="product-item gap14 mb-10">
                                                        <div class="image no-bg">
                                                            <img src="{{ asset('dashboard/images/products/21.png') }}"
                                                                alt="">
                                                        </div>
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                                    ...
                                                    <li class="product-item gap14 mb-10">
                                                        <div class="image no-bg">
                                                            <img src="{{ asset('dashboard/images/products/22.png') }}"
                                                                alt="">
                                                        </div>
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                                    ...
                                                    <li class="product-item gap14">
                                                        <div class="image no-bg">
                                                            <img src="{{ asset('dashboard/images/products/23.png') }}"
                                                                alt="">
                                                        </div>
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                        ...
                                        <button class="btn btn-secondary dropdown-toggle" type="button"
                                            ...
                                            <span class="header-user wg-user">
                                                ...
                                                <span class="flex flex-column">
                                                    ...
                                                    <span class="body-title mb-2">{{ Auth::user()->Utype }}</span>
